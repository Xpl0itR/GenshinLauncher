...
namespace GenshinLauncher.FileParsers
{
    public class LauncherIni : Ini
    {
        ...
        private IniParser.Model.KeyDataCollection SectionLauncher => this.Data[SectionNameLauncher];
        private IniParser.Model.KeyDataCollection SectionCustom => this.Data[nameof(GenshinLauncher)];
